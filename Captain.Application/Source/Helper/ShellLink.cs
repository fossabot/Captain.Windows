...
// TODO(sanlyx): Should I bother refactoring this just for creating a damn shortcut?
//               Haven't slept for a couple of days, take a nap and think about it
...
namespace Captain.Application {
  ...
  internal class ShellLink : IDisposable {
    ...
    private struct WIN32_FIND_DATAW {
      ...
      [MarshalAs(UnmanagedType.ByValTStr, SizeConst = MAX_PATH)] public readonly string cFileName;
    ...
    private sealed class PropVariant : IDisposable {
      ...
      [FieldOffset(8)] private readonly IntPtr value;
    ...
    protected virtual void Dispose(bool disposing) {
      if (this.shellLink != null) {
        ...
        Marshal.FinalReleaseComObject(this.shellLink);
        this.shellLink = null;
      }
    }
