...
namespace Captain.Application {
  ...
  internal static class TemplateHelper {
    ...
    internal static string Normalize(string localizedInputTemplate, Dictionary<CommonVariable, Func<object>> templates = null) =>
      (templates ?? Templates).Aggregate(localizedInputTemplate,
        (current, template) =>
    ...
    internal static string Localize(string normalizedInputTemplate, Dictionary<CommonVariable, Func<object>> templates = null) =>
      (templates ?? Templates).Aggregate(normalizedInputTemplate,
        (current, template) =>
    ...
    internal static string GetString(string inputTemplate, Dictionary<CommonVariable, Func<object>> templates = null) =>
      (templates ?? Templates).Aggregate(inputTemplate,
        (current, template) =>
