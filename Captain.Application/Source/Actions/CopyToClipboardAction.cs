...
namespace Captain.Application {
  ...
  internal sealed class CopyToClipboardAction : Action, IFiltered, IPreBitmapEncodingAction, IHasImage {
    ...
    ///   <see cref="IPreBitmapEncodingAction.SetBitmapData(BitmapData)"/> method.
    /// </exception>
    ...
    public void SetBitmapData(BitmapData orgData) {
      using (var bmp = new Bitmap(orgData.Width, orgData.Height, (PixelFormat) orgData.PixelFormatId)) {
        // lock target bitmap
