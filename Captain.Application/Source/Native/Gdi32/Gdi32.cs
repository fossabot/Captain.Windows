...
namespace Captain.Application.Native {
  ...
  internal static class Gdi32 {
    ...
    /// </returns>
    [DllImport(nameof(Gdi32))]
    internal static extern IntPtr SelectObject([In] IntPtr hDC, [In] IntPtr hObject);
    ...
    /// </returns>
    [DllImport(nameof(Gdi32))]
    internal static extern IntPtr CreateCompatibleBitmap([In] IntPtr hDC, [In] int nWidth, [In] int nHeight);
