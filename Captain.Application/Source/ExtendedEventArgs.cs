...
namespace Captain.Application {
  ...
  internal class ExtendedEventArgs<TA, TE> : EventArgs where TA : EventArgs {
    /// <summary>
    ///   Underlying event arguments
    /// </summary>
    internal TA EventArgs { get; }

    /// <summary>
    ///   Extended data for this event
    /// </summary>
    internal TE ExtendedData { get; set; }
    ...
    internal ExtendedEventArgs(TA eventArgs, TE extendedData = default) =>
