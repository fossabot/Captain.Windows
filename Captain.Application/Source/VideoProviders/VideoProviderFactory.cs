...
namespace Captain.Application {
  internal static class VideoProviderFactory {
    ...
    internal static VideoProvider Create(Rectangle bounds, IntPtr? windowHandle = null) {
      ...
      // fallback to GDI on failure or unsupported platforms
      // TODO: consider implementing something similar to https://github.com/rgcjonas/dd4seven
      return new GdiVideoProvider(bounds, windowHandle);
    }
  }
}
