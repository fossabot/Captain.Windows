...
namespace Captain.Application {
  ...
  /// </summary>
  internal class MultiStream : Stream, IList<Stream> {
    /// <summary>
    ///   Stream enumeration.
    /// </summary>
    ...
    public override void Flush() {
      this.streams.ForEach(s => s.Flush());
    }
    ...
    public override void SetLength(long value) {
      this.streams.ForEach(s => s.SetLength(value));
    }
    ...
    public override int Read(byte[] buffer, int offset, int count) {
      return this.streams.First(s => s.CanRead).Read(buffer, offset, count);
    }
    ...
    public void CopyTo(Stream[] array, int arrayIndex) {
      this.streams.CopyTo(array, arrayIndex);
    }
    ...
    public void Insert(int index, Stream item) {
      this.streams.Insert(index, item);
    }
