...
namespace Captain.Application {
  ...
  internal class TidbitManager {
    ...
    internal TidbitManager(HudContainerInfo container) =>
    ...
    internal void RegisterTidbit(Tidbit tidbit) {
    ...
    internal void UnregisterTidbit(Tidbit tidbit) {
    ...
    private static Point CalculateTidbitLocation(Point? location = null, int verticalOffset = 0) =>
      ...
      new Size(Cursor.Current?.Size.Width ?? 0, verticalOffset + Cursor.Current?.Size.Height / 2 ?? 0);
