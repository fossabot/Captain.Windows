...
__declspec(dllexport) BOOL WINAPI CN2ProcessFindModule(_In_ const DWORD dwProcessId, _In_ const LPCWSTR szModuleBase);
...
__declspec(dllexport) DWORD WINAPI CN2ProcessFindParentProcessId(_In_ const DWORD dwProcessId);